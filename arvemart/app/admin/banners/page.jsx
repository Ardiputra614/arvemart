  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      img.onload = () => {
        ...
        if (deviation > 0.15) {
          setDimensionWarning(
            `Ratio gambar ${ratio.toFixed(2)}:1, idealnya 16:9. Akan otomatis di-crop oleh Cloudinary.`
          );
        } else {
          setDimensionWarning(null);
        }
                    ...
                    <div className="px-6 py-5 max-h-[70vh] overflow-y-auto space-y-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          Gambar Banner *
                          <span className="text-xs text-gray-500 ml-1">(Maks. 2MB, JPG/PNG/WEBP, rekomendasi 1600x900 — 16:9)</span>
                        </label>
