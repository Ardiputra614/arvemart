          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              <div className="space-y-6">
                  ...
                  {editing ? (
                    <>
                      <textarea
                        ...
                        className={`w-full px-3 py-2.5 border rounded-lg ${formErrors.refund_policy ? "border-red-500" : "border-gray-300"}`}
                      />
                    </>
                  ) : (
                    <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                      <p className="text-gray-700 whitespace-pre-wrap">
                        {profile?.refund_policy || "Belum ada kebijakan refund"}
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.instagram || "-"}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.facebook || "-"}</p>
                      )}
                    </div>
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.twitter || "-"}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                {/* Business Contact */}
                <div className="pt-4 border-t border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Kontak Bisnis</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.business_email || "-"}</p>
                      )}
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">No. HP Bisnis</label>
                      {editing ? (
                        <input
                          type="text"
                          name="business_phone"
                        ...
                        <p className="text-gray-900 font-medium">{profile?.business_phone || "-"}</p>
                      )}
                    </div>
                    <div className="md:col-span-2">
                      ...
                      {editing ? (
                        ...
                        <p className="text-gray-900 font-medium">{profile?.business_address || "-"}</p>
                      )}
                    </div>
                  </div>
                </div>
