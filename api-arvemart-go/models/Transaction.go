...
type Transaction struct {
	...
	ApplicationFee  decimal.Decimal `gorm:"column:application_fee;default:0" json:"application_fee"`
    ...
    // Ipaymu Data
    IpaymuPaymentURL  *string        `gorm:"column:ipaymu_payment_url" json:"ipaymu_payment_url"`
    IpaymuSessionID   *string        `gorm:"column:ipaymu_session_id" json:"ipaymu_session_id"`
    IpaymuReference   *string        `gorm:"column:ipaymu_reference;index" json:"ipaymu_reference"`
    IpaymuVa          *string        `gorm:"column:ipaymu_va" json:"ipaymu_va"`
    IpaymuQRString    *string        `gorm:"column:ipaymu_qr_string" json:"ipaymu_qr_string"`
    IpaymuExpiry      *time.Time     `gorm:"column:ipaymu_expiry" json:"ipaymu_expiry"`
    IpaymuResponse    datatypes.JSON `gorm:"column:ipaymu_response" json:"ipaymu_response"`
